...
# DBSession = sessionmaker(bind=enne)
# session = DBSession()
# @contextmanager
# def get_session():
#     session = DBSession()
...
def fbconnect():
    ...
    app_id = json.loads(open('pkg/clientSecrets/fbClientSecrets.json', 'r').read())['web']['app_id']
    app_secret = json.loads(open('pkg/clientSecrets/fbClientSecrets.json', 'r').read())['web']['app_secret']
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets('pkg/clientSecrets/googleClientSecrets.json', scope='')
    ...
    CLIENT_ID = json.loads(open('pkg/clientSecrets/googleClientSecrets.json', 'r').read())['web']['client_id']
